<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <!-- Show only the first error for 'first_name' -->
        ...
        <div class="mt-4">
            ...
            <!-- Show only the first error for 'middle_name' -->
            <x-input-error :messages="$errors->first('middle_name')" class="mt-2" />
        </div>
        ...
        <div class="mt-4">
            ...
            <!-- Show only the first error for 'last_name' -->
        ...
        <div class="mt-4">
            ...
            <!-- Show only the first error for 'phone' -->
        ...
        <div class="mt-4">
            ...
            <!-- Show only the first error for 'date_of_birth' -->
            <x-input-error :messages="$errors->first('date_of_birth')" class="mt-2" />
        </div>
        ...
        <div class="mt-4">
            ...
            <!-- Show only the first error for 'email' -->
        ...
        <div class="mt-4">
            ...
            <!-- Show only the first error for 'password' -->
        ...
        <div class="mt-4">
            ...
            <!-- Show only the first error for 'password_confirmation' -->
